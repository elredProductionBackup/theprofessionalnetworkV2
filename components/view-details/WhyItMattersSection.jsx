...
const DEFAULT_ATTEND_HEADING = "Who Should Attend This Leadership Training Program?";
          ...
          <div className="mt-3 grid w-full items-start gap-10 lg:grid-cols-2 lg:gap-16">
            <div>
              {attendParagraphs.map((para, i) => (
                <p
                  key={i}
                  className={`font-inter text-[16px] font-normal leading-[1.4] tracking-normal text-[#231F20] ${i === 0 ? "" : "mt-4"}`}
                >
                  {para}
                </p>
              ))}
