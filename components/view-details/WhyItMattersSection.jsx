  ...
  return (
    <section className="font-inter bg-white">
      <div className="mx-auto w-[95%] max-w-[1440px] px-5 pb-14 md:px-[100px] md:pb-20">
        ...
        <div className="mt-14">
          <h2 className="font-inter w-full text-[22px] font-semibold leading-[1.4] tracking-normal text-slate-900 sm:text-[32px]">
            {attendHeading}
          </h2>
          ...
          <div className="mt-3 grid w-full items-start gap-10 lg:grid-cols-2 lg:gap-16">
            <div>
              {attendParagraphs.map((para, i) => (
                <p
                  key={i}
                  className={`font-inter sm:text-[17px] text-[14px] font-normal leading-[1.4] tracking-normal text-[#231F20] ${i === 0 ? "" : "mt-4"}`}
                >
                  {para}
                </p>
              ))}
