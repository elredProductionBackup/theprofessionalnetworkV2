      ...
      <div className="relative bg-white w-[1150px] h-[90vh] rounded-[30px] p-[10px] md:p-10 flex flex-col shadow-2xl overflow-hidden z-10">
        ...
        <div className="flex-grow overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          ...
          <div className="flex md:flex-row flex-col items-center justify-center gap-6 pt-[60px] pb-[30px]">
            ...
            <a href="mailto:info@theprofessionals.network?subject=I%20have%20a%20question" className="font-inter-display text-[22px] text-[#333336] underline underline-offset-4 hover:opacity-70 transition-opacity font-medium">
              contact us
            </a>
          </div>
        </div>
