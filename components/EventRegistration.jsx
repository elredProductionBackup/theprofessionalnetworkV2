      ...
      <div className="relative mx-auto max-w-6xl px-5 py-14 md:px-8 md:py-20">
        ...
        <div className="mt-10 rounded-3xl border border-rose-200 bg-rose-50/70 p-6 md:mt-14 md:p-10">
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
            <div>
              <span className="inline-block rounded-md px-3 py-1 text-xs font-bold uppercase tracking-wider text-white" style={{ backgroundColor: RED }}>
                Preview Price
              </span>
              <div className="mt-6 flex h-12 w-12 items-center justify-center rounded-xl border-2" style={{ borderColor: RED, color: RED }}>
              ...
              <button className="mt-6 rounded-full px-8 py-3 text-sm font-semibold text-white transition hover:opacity-90" style={{ backgroundColor: RED }} onClick={openApply}>
                Register
              </button>
            </div>
            ...
            <div className="space-y-4">
              {tiers.map(({ icon: Icon, title, price, desc }) => (
                <div key={title} className="rounded-2xl bg-white p-5 shadow-sm md:p-6">
                  <div className="flex items-start gap-4">
                    <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-rose-100" style={{ color: RED }}>
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center justify-between gap-1">
                        ...
                        <p className="text-lg font-bold" style={{ color: RED }}>
                          INR {price} <span className="text-sm font-medium text-slate-500">+ tax</span>
                        </p>
                      </div>
          ...
          <div className="relative z-10 flex max-h-[90vh] w-full max-w-[700px] flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
            ...
            <div className="overflow-y-auto px-6 pb-6 pt-7 sm:px-8">
              <div className="flex items-center gap-3 pr-24">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-slate-900">{speaker.school}</h3>
              </div>
